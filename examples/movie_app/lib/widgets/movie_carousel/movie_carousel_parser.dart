...
class MovieCarouselParser extends PhlutsParser<PhlutsMovieCarousel> {
  ...
  @override
  PhlutsMovieCarousel getModel(Map<String, dynamic> json) =>
      PhlutsMovieCarousel.fromJson(json);

  @override
  Widget parse(BuildContext context, PhlutsMovieCarousel model) {
    return FutureBuilder(
      future: PhlutsNetworkService.request(context, model.request),
