...
class CounterScreenParser extends PhlutsParser<CounterScreen> {
            ...
            floatingActionButton: Row(
              ...
              children: [
                FloatingActionButton(
                  onPressed: () =>
                      Phluts.onCallFromJson(model.onDecrement, context),
                  tooltip: 'Decrement',
                ...
                FloatingActionButton(
                  onPressed: () =>
                      Phluts.onCallFromJson(model.onIncrement, context),
                  tooltip: 'Increment',
