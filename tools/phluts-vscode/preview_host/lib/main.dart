...
class _PreviewAppState extends State<_PreviewApp> {
      ...
      home: _json == null
          ...
          : KeyedSubtree(
              ...
              child: Scaffold(
                body: Builder(
                  builder: (context) {
                    final widget = Phluts.fromJson(_json, context);
                    if (widget == null) {
                      return const Center(
                        child: Text(
  ...
  ThemeData? _buildThemeData(BuildContext context) {
    ...
    try {
      ThemeData? themeData;
      if (_themeJson != null) {
        final phlutsTheme = PhlutsTheme.fromJson(_themeJson!);
        themeData = phlutsTheme.parse(context);
      }
  ...
  void _onMessage(web.MessageEvent event) {
    ...
    if (type == 'phluts.preview.setPlatform') {
    ...
    if (type == 'phluts.preview.loadFonts') {
      _loadFonts(message['fonts']);
      return;
    }

    if (type != 'phluts.preview.render') return;
  ...
  void _log(String message) {
    _post({'type': 'phluts.preview.log', 'message': message});
  }
