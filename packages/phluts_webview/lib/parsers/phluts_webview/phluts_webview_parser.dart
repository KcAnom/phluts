...
import 'package:phluts_webview/parsers/phluts_webview/phluts_webview.dart';
import 'package:webview_flutter/webview_flutter.dart';

/// [PhlutsWebViewParser] is a class that parses the `webView` widget from JSON.
class PhlutsWebViewParser extends PhlutsParser<PhlutsWebView> {
  const PhlutsWebViewParser();

  /// [webView] is the type defined for PhlutsWebViewParser.
  @override
  String get type => 'webView';

  /// [getModel] method parses the JSON data and returns a [PhlutsWebView] object.
  ///
  /// {@macro getModel}
  @override
