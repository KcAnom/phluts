...
import 'package:phluts_cli/src/models/project/project_access.dart';

import '../exceptions/phluts_exception.dart';
import '../utils/console_logger.dart';
import '../utils/http_client.dart';

/// Service for managing Phluts SDUI projects on the cloud
class ProjectService {
  ...
  Future<List<Project>> fetchProjects({
    ...
    try {
      ...
      throw PhlutsException('Failed to fetch projects: $e', cause: e);
    }
  }
  ...
  Future<Project> createProject({
    ...
    try {
      ...
      throw PhlutsException('Failed to create project: $e', cause: e);
    }
  }
  ...
  Future<Project?> selectProjectInteractively() async {
    ...
    await ConsoleLogger.showLoader(
      'Fetching projects from Phluts cloud',
      () async {
