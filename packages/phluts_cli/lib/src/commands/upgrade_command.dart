...
/// Command for upgrading the Phluts CLI to the latest version
class UpgradeCommand extends BaseCommand {
  ...
  @override
  String get description => 'Upgrade Phluts CLI to the latest version';
  ...
  Future<int> execute() async {
    ...
    try {
      ...
      ConsoleLogger.info('Run "phluts --version" to verify');
