...
/// Command to add Phluts AI agent skills
class AddCommand extends BaseCommand {
  @override
  String get name => 'add';

  @override
  String get description => 'Add Phluts AI agent skills to your project';
  ...
  Future<int> execute() async {
    String repoUrl = 'https://github.com/PhlutsDev/phluts';
    ...
    final tempDir = await Directory.systemTemp.createTemp('phluts_skills_');
    try {
      final dio = Dio();
