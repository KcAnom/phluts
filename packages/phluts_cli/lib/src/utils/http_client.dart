...
/// HTTP client wrapper for making API requests to Phluts cloud services
class HttpClientService {
      ...
      InterceptorsWrapper(
        ...
        onError: (error, handler) {
          ...
          if (error.response?.statusCode == 401) {
            ...
            throw PhlutsException('Permission denied');
          } else if (error.response?.statusCode == 404) {
            throw PhlutsException('Resource not found');
          }
  ...
  Future<Response> get(
    ...
    try {
      ...
      if (underlying is PhlutsException) {
        throw underlying;
      }
  ...
  Future<Response> post(String path, {dynamic data}) async {
    try {
      ...
      throw PhlutsException('HTTP request failed: $e');
    }
  }
