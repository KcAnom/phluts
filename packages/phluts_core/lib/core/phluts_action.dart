...
/// Base class for all Phluts actions that can be performed on widgets.
///
/// Actions represent user interactions or system events that can be triggered
/// on Phluts widgets. Each action type extends this base class and provides
/// specific functionality through the `actionType` getter.
///
/// Example usage:
/// ```dart
/// // Create a custom action
/// class CustomAction extends PhlutsAction {
...
///
/// // Parse from JSON
/// final action = PhlutsAction.fromJson({'type': 'custom', 'data': 'value'});
/// ```
///
/// JSON representation:
/// ```json
...
class PhlutsAction {
  ...
  /// Creates a PhlutsAction instance from JSON data.
  ///
  /// This factory constructor takes a JSON map and creates a PhlutsAction
  ...
  ///
  /// Returns a new PhlutsAction instance with the provided JSON data.
  factory PhlutsAction.fromJson(Map<String, dynamic> json) {
    return PhlutsAction(jsonData: json);
  }
