...
part 'phluts_sliver_grid.g.dart';

/// A Phluts model representing Flutter's [SliverGrid] widget.
///
...
/// Dart Example:
/// ```dart
/// const PhlutsSliverGrid(
///   crossAxisCount: 2,
///   mainAxisSpacing: 12,
///   crossAxisSpacing: 12,
///   childAspectRatio: 1.0,
///   children: [
///     PhlutsContainer(color: '#FF5722'),
///     PhlutsContainer(color: '#4CAF50'),
///   ],
/// )
/// ```
/// {@end-tool}
...
@JsonSerializable()
class PhlutsSliverGrid extends PhlutsWidget {
  /// Creates a [PhlutsSliverGrid] with the given properties.
  const PhlutsSliverGrid({
    this.crossAxisCount,
  ...
  /// Creates a [PhlutsSliverGrid] from a JSON map.
  factory PhlutsSliverGrid.fromJson(Map<String, dynamic> json) =>
      _$PhlutsSliverGridFromJson(json);

  /// Converts this [PhlutsSliverGrid] instance to a JSON map.
  @override
  Map<String, dynamic> toJson() => _$PhlutsSliverGridToJson(this);
}
