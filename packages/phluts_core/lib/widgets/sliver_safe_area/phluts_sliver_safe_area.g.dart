...
PhlutsSliverSafeArea _$PhlutsSliverSafeAreaFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$PhlutsSliverSafeAreaToJson(PhlutsSliverSafeArea instance) =>
    <String, dynamic>{
      'left': instance.left,
      'top': instance.top,
