...
part 'phluts_filled_button.g.dart';

/// A Phluts model representing Flutter's [FilledButton] widget.
///
...
/// ```
@JsonSerializable()
class PhlutsFilledButton extends PhlutsWidget {
  /// Creates a [PhlutsFilledButton] with the given properties.
  const PhlutsFilledButton({
    this.onPressed,
    this.onLongPress,
    this.onHover,
    this.onFocusChange,
  ...
  /// Creates a [PhlutsFilledButton] from JSON.
  factory PhlutsFilledButton.fromJson(Map<String, dynamic> json) =>
      _$PhlutsFilledButtonFromJson(json);

  /// Converts this button to JSON.
  @override
  Map<String, dynamic> toJson() => _$PhlutsFilledButtonToJson(this);
}
