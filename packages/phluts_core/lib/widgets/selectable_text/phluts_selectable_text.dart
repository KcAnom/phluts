...
part 'phluts_selectable_text.g.dart';
...
///  data: 'Hello World',
///  style: PhlutsTextStyle(fontSize: 20, color: '#FF0000'),
///  showCursor: true,
/// )
/// ```
/// {@end-tool}
...
/// {@end-tool}
@JsonSerializable()
class PhlutsSelectableText extends PhlutsWidget {
  /// Creates a [PhlutsSelectableText].
  const PhlutsSelectableText({
    required this.data,
    this.children,
    this.style,
    this.copyWithStyle,
  ...
  /// Creates a [PhlutsSelectableText] from a JSON map.
  factory PhlutsSelectableText.fromJson(Map<String, dynamic> json) =>
      _$PhlutsSelectableTextFromJson(json);

  /// Converts this [PhlutsSelectableText] instance to a JSON map.
  @override
  Map<String, dynamic> toJson() => _$PhlutsSelectableTextToJson(this);
}
