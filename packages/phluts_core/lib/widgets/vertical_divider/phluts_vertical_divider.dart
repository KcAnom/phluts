...
part 'phluts_vertical_divider.g.dart';

/// A Phluts model representing Flutter's [VerticalDivider] widget.
///
...
///   indent: 10.0,
///   endIndent: 10.0,
///   color: PhlutsColor(value: 0xFF000000),
/// )
/// ```
/// {@end-tool}
///
...
/// {@end-tool}
@JsonSerializable()
class PhlutsVerticalDivider extends PhlutsWidget {
  /// Creates a [PhlutsVerticalDivider].
  ///
  /// The [width], [thickness], [indent], [endIndent], and [color] arguments
  /// must not be null if they are not defaulted.
  const PhlutsVerticalDivider({
    this.width,
    this.thickness,
    this.indent,
    this.endIndent,
  ...
  /// The type of this Phluts widget.
  ///
  /// This is used to identify the widget type in JSON serialization.
  @override
  String get type => WidgetType.verticalDivider.name;

  /// Creates a [PhlutsVerticalDivider] instance from a JSON map.
  ///
  /// The [json] argument must be a valid JSON representation of a
  /// [PhlutsVerticalDivider].
  factory PhlutsVerticalDivider.fromJson(Map<String, dynamic> json) =>
      _$PhlutsVerticalDividerFromJson(json);

  /// Converts this [PhlutsVerticalDivider] instance to a JSON map.
  @override
  Map<String, dynamic> toJson() => _$PhlutsVerticalDividerToJson(this);
}
