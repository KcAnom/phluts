...
part 'phluts_border_side.g.dart';

/// A Phluts representation of a single border side.
///
...
/// {@end-tool}
@JsonSerializable()
class PhlutsBorderSide implements PhlutsElement {
  ...
  static const none = PhlutsBorderSide(
    width: 0,
    borderStyle: PhlutsBorderStyle.none,
  );

  /// Creates a [PhlutsBorderSide] from JSON.
  factory PhlutsBorderSide.fromJson(Map<String, dynamic> json) =>
      _$PhlutsBorderSideFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$PhlutsBorderSideToJson(this);
}
