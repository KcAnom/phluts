/// Type alias for Phluts color representation as a hex string.
///
/// Colors in the Phluts framework are represented as hex strings (e.g., '#FF0000')
/// or theme color names (e.g., 'primary', 'secondary').
typedef PhlutsColor = String;

/// Extension on [PhlutsColor] to provide additional functionality.
extension PhlutsColorExtension on PhlutsColor {
  ...
  /// Dart Example:
  /// ```dart
  /// PhlutsColors.primary.withOpacity(0.8)  // Returns "primary@80"
  /// PhlutsColors.blue.withOpacity(0.5)     // Returns "blue@50"
  ...
  PhlutsColor withOpacity(double opacity) {
...
/// A collection of predefined colors for the Phluts framework.
///
...
/// throughout Phluts applications.
///
