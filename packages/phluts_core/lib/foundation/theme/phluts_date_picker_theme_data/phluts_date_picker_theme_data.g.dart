...
part of 'phluts_date_picker_theme_data.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PhlutsDatePickerThemeData _$PhlutsDatePickerThemeDataFromJson(
  ...
  headerHeadlineStyle: json['headerHeadlineStyle'] == null
      ? null
      : PhlutsTextStyle.fromJson(json['headerHeadlineStyle']),
  headerHelpStyle: json['headerHelpStyle'] == null
      ? null
      : PhlutsTextStyle.fromJson(json['headerHelpStyle']),
  weekdayStyle: json['weekdayStyle'] == null
      ? null
      : PhlutsTextStyle.fromJson(json['weekdayStyle']),
  dayStyle: json['dayStyle'] == null
      ? null
      : PhlutsTextStyle.fromJson(json['dayStyle']),
  ...
  dayShape: json['dayShape'] == null
      ? null
      : PhlutsShapeBorder.fromJson(json['dayShape'] as Map<String, dynamic>),
  ...
  todayBorder: json['todayBorder'] == null
      ? null
      : PhlutsBorderSide.fromJson(json['todayBorder'] as Map<String, dynamic>),
  yearStyle: json['yearStyle'] == null
      ? null
      : PhlutsTextStyle.fromJson(json['yearStyle']),
  ...
  rangePickerHeaderHeadlineStyle: json['rangePickerHeaderHeadlineStyle'] == null
      ? null
      : PhlutsTextStyle.fromJson(json['rangePickerHeaderHeadlineStyle']),
  rangePickerHeaderHelpStyle: json['rangePickerHeaderHelpStyle'] == null
      ? null
      : PhlutsTextStyle.fromJson(json['rangePickerHeaderHelpStyle']),
...
Map<String, dynamic> _$PhlutsDatePickerThemeDataToJson(
  PhlutsDatePickerThemeData instance,
) => <String, dynamic>{
