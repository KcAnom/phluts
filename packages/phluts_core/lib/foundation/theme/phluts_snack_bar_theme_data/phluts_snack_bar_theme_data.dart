...
part 'phluts_snack_bar_theme_data.g.dart';

/// A Phluts model representing Flutter's [SnackBarThemeData].
///
...
///   contentTextStyle: PhlutsTextStyle(color: '#FFFFFF'),
...
/// {@end-tool}
@JsonSerializable()
class PhlutsSnackBarThemeData implements PhlutsElement {
  /// Creates a [PhlutsSnackBarThemeData] with the given properties.
  const PhlutsSnackBarThemeData({
    this.behavior,
  ...
  /// Creates a [PhlutsSnackBarThemeData] from JSON.
  factory PhlutsSnackBarThemeData.fromJson(Map<String, dynamic> json) =>
      _$PhlutsSnackBarThemeDataFromJson(json);

  /// Converts this snack bar theme to JSON.
  @override
  Map<String, dynamic> toJson() => _$PhlutsSnackBarThemeDataToJson(this);
}
