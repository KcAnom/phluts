...
part 'phluts_material_color.g.dart';

/// A Phluts model representing Flutter's [MaterialColor].
///
...
/// {@end-tool}
@JsonSerializable()
class PhlutsMaterialColor implements PhlutsElement {
  /// Creates a [PhlutsMaterialColor] with the given properties.
  const PhlutsMaterialColor({
  ...
  /// Creates a [PhlutsMaterialColor] from JSON.
  factory PhlutsMaterialColor.fromJson(Map<String, dynamic> json) =>
      _$PhlutsMaterialColorFromJson(json);

  /// Converts this material color to JSON.
  @override
  Map<String, dynamic> toJson() => _$PhlutsMaterialColorToJson(this);
}
