...
part 'phluts_scrollbar_theme_data.g.dart';

/// A Phluts model representing Flutter's [ScrollbarThemeData].
///
...
/// {@end-tool}
@JsonSerializable()
class PhlutsScrollbarThemeData implements PhlutsElement {
  /// Creates a [PhlutsScrollbarThemeData] with the given properties.
  const PhlutsScrollbarThemeData({
  ...
  /// Creates a [PhlutsScrollbarThemeData] from JSON.
  factory PhlutsScrollbarThemeData.fromJson(Map<String, dynamic> json) =>
      _$PhlutsScrollbarThemeDataFromJson(json);

  /// Converts this scrollbar theme to JSON.
  @override
  Map<String, dynamic> toJson() => _$PhlutsScrollbarThemeDataToJson(this);
}
