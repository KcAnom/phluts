...
part 'phluts_color_scheme.g.dart';

/// A Phluts model representing Flutter's [ColorScheme].
///
...
/// {@end-tool}
@JsonSerializable()
class PhlutsColorScheme implements PhlutsElement {
  /// Creates a [PhlutsColorScheme] with the given properties.
  const PhlutsColorScheme({
  ...
  /// Creates a [PhlutsColorScheme] from JSON.
  factory PhlutsColorScheme.fromJson(Map<String, dynamic> json) =>
      _$PhlutsColorSchemeFromJson(json);

  /// Converts this color scheme to JSON.
  @override
  Map<String, dynamic> toJson() => _$PhlutsColorSchemeToJson(this);
}
