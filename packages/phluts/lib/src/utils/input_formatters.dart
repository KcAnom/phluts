    ...
    try {
      switch (this) {
        ...
        case InputFormatterType.mask:
          return _PhlutsMaskInputFormatter(mask: mask ?? '', rule: rule);
      }
    } catch (e) {
      Log.e(e);
...
class _PhlutsMaskInputFormatter extends TextInputFormatter {
  _PhlutsMaskInputFormatter({required this.mask, required String rule})
