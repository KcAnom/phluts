...
class PhlutsGestureDetectorParser extends PhlutsParser<PhlutsGestureDetector> {
  ...
  @override
  PhlutsGestureDetector getModel(Map<String, dynamic> json) =>
      PhlutsGestureDetector.fromJson(json);

  @override
  Widget parse(BuildContext context, PhlutsGestureDetector model) {
