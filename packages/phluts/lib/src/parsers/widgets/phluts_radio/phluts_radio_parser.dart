...
class PhlutsRadioParser extends PhlutsParser<PhlutsRadio> {
  const PhlutsRadioParser();

  @override
  PhlutsRadio getModel(Map<String, dynamic> json) => PhlutsRadio.fromJson(json);

  @override
  String get type => WidgetType.radio.name;

  @override
  Widget parse(BuildContext context, PhlutsRadio model) {
...
class _RadioWidgetState extends State<_RadioWidget> {
  ...
  Widget build(BuildContext context) {
    switch (widget.model.radioType ?? PhlutsRadioType.material) {
      case PhlutsRadioType.cupertino:
        return _buildCupertinoRadio(context);
      case PhlutsRadioType.adaptive:
        return _buildAdaptiveRadio(context);
      case PhlutsRadioType.material:
