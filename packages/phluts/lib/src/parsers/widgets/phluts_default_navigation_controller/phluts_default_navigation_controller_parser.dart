...
class PhlutsDefaultNavigationControllerParser
    extends PhlutsParser<PhlutsDefaultNavigationController> {
  ...
  @override
  PhlutsDefaultNavigationController getModel(Map<String, dynamic> json) =>
      PhlutsDefaultNavigationController.fromJson(json);

  @override
  Widget parse(BuildContext context, PhlutsDefaultNavigationController model) {
...
class _DefaultNavigationControllerWidget extends StatefulWidget {
  ...
  final PhlutsDefaultNavigationController model;
...
/// descendant widgets such as [PhlutsNavigationBar], [PhlutsBottomNavigationBar]
/// and [PhlutsNavigationView].
///
/// Typically created by [PhlutsDefaultNavigationController].
