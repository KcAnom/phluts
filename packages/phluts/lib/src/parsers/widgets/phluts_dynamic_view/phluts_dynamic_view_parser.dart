...
class PhlutsDynamicViewParser extends PhlutsParser<PhlutsDynamicView> {
  ...
  @override
  PhlutsDynamicView getModel(Map<String, dynamic> json) {
    return PhlutsDynamicView.fromJson(json);
  }

  @override
  Widget parse(BuildContext context, PhlutsDynamicView model) {
            ...
            try {
              ...
              if (data != null) {
                ...
                final renderedTemplate = _applyDataToTemplate(
                  model.template ?? PhlutsSizedBox(),
                  dataForTemplate,
                  model.resultTarget ?? "",
                );
                return Phluts.fromJson(renderedTemplate, context) ??
                    const SizedBox();
              }
            } catch (e) {
  ...
  Future<Response?> _fetchData(
    ...
    PhlutsDynamicView model,
  ) async {
    try {
      return await PhlutsNetworkService.request(context, model.request);
    } catch (e) {
