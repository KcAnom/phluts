...
/// [PhlutsActionParser] is an abstract class that is used to parse a JSON object into
/// a model and then handle an action based on the model.
///
/// This is used to create a parser for each type of PHLUTS action.
abstract class PhlutsActionParser<T> {
  const PhlutsActionParser();
  ...
  /// The JSON object is typically a part of the PHLUTS action.
