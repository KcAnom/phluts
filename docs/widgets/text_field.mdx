...
The Phluts TextField allows you to build a Flutter text field widget using JSON. To know more about the text field widget in Flutter, refer to the [official documentation](https://api.flutter.dev/flutter/material/TextField-class.html).

## Properties

| Property           | Type                        | Description                                                                    |
|--------------------|-----------------------------|--------------------------------------------------------------------------------|
| decoration         | `PhlutsInputDecoration`       | The decoration to show around the text field.                                  |
...
| textCapitalization | `PhlutsTextCapitalization`    | How the text should be capitalized.                                            |
| style              | `PhlutsTextStyle`             | The style to use for the text being edited.                                    |
| textAlign          | `PhlutsTextAlign`             | How the text should be aligned horizontally.                                   |
| textAlignVertical  | `PhlutsTextAlignVertical`     | How the text should be aligned vertically.                                     |
| textDirection      | `PhlutsTextDirection`         | The direction in which the text flows.                                         |
...
PhlutsTextField(
  initialValue: 'Enter text here',
  decoration: PhlutsInputDecoration(hintText: 'Enter your name'),
  style: PhlutsTextStyle(color: PhlutsColors.black, fontSize: 16.0),
