...
The Phluts Flexible allows you to build a Flutter flexible widget using JSON.
...
|----------|-------------------------|------------------------------------------------------------------------------------------|
| child    | `PhlutsWidget`            | The widget to display inside the flexible widget.                                        |
| flex     | `int`                   | The flex factor to use for the flexible widget. Defaults to `1`.                         |
| fit      | `PhlutsFlexFit`           | How the child should be inscribed into the available space. Defaults to `FlexFit.loose`. |
