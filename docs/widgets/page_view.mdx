...
The Phluts PageView allows you to build a Flutter PageView widget using JSON.
...
|------------------------|------------------------------|-------------------------------------------------------------------------------|
| scrollDirection        | `PhlutsAxis`                   | The axis along which the page view scrolls. Defaults to `Axis.horizontal`.    |
...
| onPageChanged          | `PhlutsAction`                 | The callback that is called when the page changes.                            |
...
| clipBehavior           | `PhlutsClip`                   | The clip behavior of the page view. Defaults to `Clip.hardEdge`.              |
  ...
  children: [
    PhlutsContainer(
      ...
      child: PhlutsCenter(
        child: PhlutsText(
          data: 'Page 1',
          style: PhlutsTextStyle(fontSize: 23, fontWeight: PhlutsFontWeight.w400),
        ),
      ),
    ),
    PhlutsContainer(
      color: PhlutsColors.orange,
      child: PhlutsCenter(
        child: PhlutsText(
          data: 'Page 2',
          style: PhlutsTextStyle(fontSize: 23, fontWeight: PhlutsFontWeight.w400),
