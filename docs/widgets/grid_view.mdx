...
The Phluts GridView allows you to build a Flutter GridView widget using JSON.
...
|-------------------------|-----------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| scrollDirection         | `PhlutsAxis`                              | The axis along which the grid scrolls. Defaults to `Axis.vertical`.                                                                  |
...
| physics                 | `PhlutsScrollPhysics`                     | The physics for the scroll view.                                                                                                     |
...
| padding                 | `PhlutsEdgeInsets`                        | The amount of space by which to inset the grid.                                                                                      |
...
| children                | `List<PhlutsWidget>`                      | The widgets below this widget in the tree. Defaults to an empty list.                                                                |
...
| keyboardDismissBehavior | `PhlutsScrollViewKeyboardDismissBehavior` | The keyboard dismiss behavior. Defaults to `ScrollViewKeyboardDismissBehavior.manual`.                                               |
| restorationId           | `String`                                | The restoration ID to save and restore the scroll offset.                                                                            |
| clipBehavior            | `PhlutsClip`                              | The clip behavior of the grid. Defaults to `Clip.hardEdge`.                                                                          |
...
PhlutsGridView(
  ...
  reverse: false,
  primary: false,
  physics: PhlutsScrollPhysics(name: 'bouncing'),
  shrinkWrap: false,
  padding: PhlutsEdgeInsets(left: 10, top: 10, right: 10, bottom: 10),
  crossAxisCount: 2,
  ...
  keyboardDismissBehavior: PhlutsScrollViewKeyboardDismissBehavior.manual,
  restorationId: 'grid_view_1',
