...
Phluts `SafeArea` allows you to build the Flutter SafeArea widget using JSON. 
...
|---------------------------|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| child                     | `PhlutsWidget`           | The child widget of the SafeArea.                                                                                                                     |
...
| minimum                   | `PhlutsEdgeInsets`       | This minimum padding to apply.                                                                                                                        |
...
PhlutsSafeArea(
  child: PhlutsText(
    data: 'Hello, World!',
    style: PhlutsTextStyle(color: PhlutsColors.white, fontSize: 24.0),
  ),
)
```
