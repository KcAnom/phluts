...
The Phluts FractionallySizedBox allows you to build a Flutter fractionally sized box widget using JSON.
...
|--------------|-------------------------|-----------------------------------------------------------------------------|
| alignment    | `PhlutsAlignment`         | The alignment of the child within the fractionally sized box.               |
...
| child        | `PhlutsWidget`            | The widget to display inside the fractionally sized box.                    |
