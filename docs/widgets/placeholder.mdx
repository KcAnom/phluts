...
The Phluts `Placeholder` widget allows you to build the Flutter Placeholder widget using JSON.
...
|------------------|-------------------------|---------------------------------------------------------------------------------------------------------|
| `color`          | `PhlutsColor`             | The hex color to paint behind the child. Defaults to `#455A64` (Blue Grey 700).                         |
...
| `child`          | `PhlutsWidget`            | The widget to be displayed inside the placeholder box.                                                  |
