---
title: "Color"
description: "Documentation for Color"
---
...
PhlutsText(
  data: 'Hello World!',
  style: PhlutsTextStyle(color: 'primary'),
)
```
...
PhlutsText(
  data: 'Hello World!',
  style: PhlutsTextStyle(color: '#000000'),
)
```
...
PhlutsText(
  data: 'Hello World!',
  style: PhlutsTextStyle(color: PhlutsColors.black),
)
```
