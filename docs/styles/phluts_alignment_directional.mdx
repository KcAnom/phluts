---
title: "PhlutsAlignmentDirectional"
description: "Documentation for PhlutsAlignmentDirectional"
---

# PhlutsAlignmentDirectional

Phluts AlignmentDirectional allows you to handle alignment widget using JSON.
...
<CodeGroup>
```dart Dart
PhlutsFittedBox(alignment: PhlutsAlignmentDirectional.center)
```
