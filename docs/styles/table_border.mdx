---
title: "Table Border"
description: "Documentation for Table Border"
---

# Table Border

PhlutsTableBorder allows you to define the Flutter TableBorder class using JSON.
...
| borderRadius | `PhlutsBorderRadius` | Defines the border radius of the table border. |
