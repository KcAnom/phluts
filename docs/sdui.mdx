...
- Higher implementation complexity (Phluts makes this much easier)
...
- Read how Phluts renders widgets in [Rendering Phluts Widgets](./concepts/rendering_phluts_widgets).
