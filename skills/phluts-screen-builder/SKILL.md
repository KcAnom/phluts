---
name: phluts-screen-builder
description: Build Phluts DSL screens and themes from product requirements with safe defaults and reusable templates. Use when users ask to create or refactor PhlutsScreen files, map UI requirements to Phluts widgets/actions/styles, or scaffold new screen/theme files.
---
...
Use this skill to convert feature requirements into maintainable Phluts DSL screens and theme definitions.
...
- Return valid Phluts DSL snippets with `@PhlutsScreen` or `@PhlutsThemeRef`.
- Keep generated screen names stable and explicit.
- Use built-in Phluts widgets/actions first, then custom extensions if needed.
