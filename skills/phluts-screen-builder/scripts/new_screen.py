#!/usr/bin/env python3
"""Scaffold a Phluts screen file from template."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create a Phluts screen Dart file.")
...
def main() -> int:
    ...
    if args.with_navigation:
        navigation_block = """          PhlutsSizedBox(height: 16),
          PhlutsFilledButton(
            onPressed: PhlutsNavigator.pushPhluts('detail_screen'),
            child: PhlutsText(data: 'Go to Detail'),
          ),"""
    else:
