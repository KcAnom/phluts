---
name: phluts-custom-extensions
description: Scaffold and integrate custom Phluts widgets and actions with parsers and registration checks. Use when users ask to build new PhlutsParser or PhlutsActionParser implementations, generate custom model classes, or verify parser registration inside Phluts.initialize.
---
...
Use this skill to add custom widgets/actions that serialize cleanly and register correctly in a Phluts app.
...
- Include registration snippet for `Phluts.initialize`.
