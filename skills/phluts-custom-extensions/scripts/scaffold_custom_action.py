...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scaffold custom Phluts action files.")
    parser.add_argument("--name", required=True, help="PascalCase class name.")
    parser.add_argument(
        "--action-type", required=True, help="Phluts action type identifier."
    )
...
def main() -> int:
    ...
    parser_class = f"Phluts{args.name}ActionParser"
    mapping = {
