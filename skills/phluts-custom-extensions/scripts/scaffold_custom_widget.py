...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scaffold custom Phluts widget files.")
    parser.add_argument("--name", required=True, help="PascalCase class name.")
    parser.add_argument("--type", required=True, help="Phluts widget type identifier.")
...
def main() -> int:
    ...
    parser_class = f"Phluts{args.name}Parser"
    mapping = {
