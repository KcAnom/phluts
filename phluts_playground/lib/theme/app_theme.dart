...
import 'package:phluts_playground/theme/app_colors.dart';
import 'package:phluts_playground/theme/app_text_theme.dart';

class AppTheme {
  const AppTheme._();

  /// Console palette — mirrors the Phluts Console design tokens:
