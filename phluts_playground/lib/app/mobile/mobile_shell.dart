...
import 'package:phluts_playground/app/widgets/code_preview.dart';
...
class MobileColors {
  ...
  /// [onSurfaceVariant] as a hex string for Phluts-rendered icons.
...
/// 56px top bar: circular logo, "Phluts Playground" wordmark, menu icon.
                      ...
                      child: Column(
                        ...
                        children: [
                          row(
                            label: 'Documentation',
                            onTap: () =>
                                launchUrl(Uri.parse('https://docs.phluts.dev')),
                          ),
                          ...
                          row(
                            label: 'Github',
                            onTap: () => launchUrl(
                              Uri.parse('https://github.com/PhlutsDev/phluts'),
                            ),
                          ),
                          const SizedBox(height: 16),
                          divider,
                          ...
                          row(
                            ...
                            onTap: () => launchUrl(
                              Uri.parse(
                                'https://www.linkedin.com/company/phlutsdev',
                              ),
                            ),
                          ),
                          const SizedBox(height: 16),
                          ...
                          row(
                            label: 'X',
                            onTap: () => launchUrl(
                              Uri.parse('https://x.com/phluts_dev'),
                            ),
                          ),
                          const SizedBox(height: 16),
                          divider,
...
class _MobilePreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Phluts.fromJson(jsonData, context),
    );
  }
}
