      ...
      child: Column(
        ...
        children: [
          ...
          _RailIcon(
            ...
            onTap: () => launchUrl(Uri.parse('https://docs.phluts.dev')),
          ),
          SizedBox(
            height: 13,
            child: Center(
          ...
          _RailIcon(
            ...
            tooltip: 'GitHub',
            onTap: () =>
                launchUrl(Uri.parse('https://github.com/PhlutsDev/phluts')),
          ),
          _RailIcon(
            icon: PhosphorIcons.linkedinLogo,
            tooltip: 'LinkedIn',
            onTap: () => launchUrl(
              Uri.parse('https://www.linkedin.com/company/phlutsdev'),
            ),
          ),
          _RailIcon(
            icon: PhosphorIcons.xLogo,
            tooltip: 'X',
            onTap: () => launchUrl(Uri.parse('https://x.com/phluts_dev')),
          ),
