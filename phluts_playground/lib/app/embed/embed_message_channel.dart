...
class EmbedMessageChannel {
  static const _previewMessageType = 'phluts-preview-json';
  ...
  Map<String, dynamic>? _extractPayload(Object? data) {
    ...
    if (normalizedData['type'] == _previewMessageType) {
      ...
      return _isPhlutsWidgetJson(payload) ? payload : null;
    }

    return _isPhlutsWidgetJson(normalizedData) ? normalizedData : null;
  }
  ...
  bool _isPhlutsWidgetJson(Map<String, dynamic> json) {
